...
class HashtagPostsVC: BaseViewController {
    ...
    var hashtag: String?
    var initialHashtagForPlaceholder: String = ""
...
//        self.navigationController?.navigationBar.topItem?.backButtonTitle = "Back To Home"
    ...
    func initUI() {
        ...
        self.tableView.register(UINib(nibName: "HashtagHeaderView", bundle: nil), forHeaderFooterViewReuseIdentifier: "HashtagHeaderView")
...
//        self.tableView.refreshControl = refreshControl
        ...
        self.initialHashtagForPlaceholder = self.hashtag!
    ...
    func initVariable() {
        ...
        if self.hashtag == nil {
            popOnErrorAlert("Hashtag missing")
            return
        }
    ...
    // MARK: - Get Post List
    func getPostList() {
        self.viewModel.getPostList(pageNumber: self.pageNumber, postId: 0, profileIdentifier: "", hashtag: self.hashtag!)
    }
...
extension HashtagPostsVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        guard let header = tableView.dequeueReusableHeaderFooterView(withIdentifier: "HashtagHeaderView") as? HashtagHeaderView else {
            return UIView()
        }
        
        header.configureHeader(hashtag: self.hashtag!, hashtagPlaceholder: self.initialHashtagForPlaceholder)
        header.hastagTF.delegate = self
...
extension HashtagPostsVC: NetworkResponseProtocols {
...
extension HashtagPostsVC: AppProtocol {
...
extension HashtagPostsVC: UITextFieldDelegate {
...
//        self.pageNumber = 1
//
//        if self.hashtag?.count ?? 0 > 1 {
//            if self.hashtag!.first == "#" && self.hashtag?[1] != "#" {
//                self.hashtag?.removeFirst()
//            }
//        }
//
//        self.getPostList()
