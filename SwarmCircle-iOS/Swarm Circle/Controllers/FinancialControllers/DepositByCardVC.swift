...
class DepositByCardVC: BaseViewController {
    ...
    var actions: [(String, UIAlertAction.Style)] = [
        ...
        ("PayPal", UIAlertAction.Style.default),
...
extension DepositByCardVC: UITableViewDelegate, UITableViewDataSource {
...
extension DepositByCardVC: NetworkResponseProtocols {
...
extension DepositByCardVC: AppProtocol {
