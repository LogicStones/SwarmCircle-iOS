...
class DefaultAudioDevice: NSObject {
    ...
    fileprivate func setupAudioUnit(withPlayout playout: Bool) -> Bool {
        ...
        if playout {
            ...
            guard let recordingVoiceUnt = self.recordingVoiceUnit else {
                return true
            }
            self.recordingVoiceUnit = recordingVoiceUnt
            AudioUnitSetProperty(self.recordingVoiceUnit!, kAudioOutputUnitProperty_EnableIO, kAudioUnitScope_Output,
...
extension DefaultAudioDevice: OTAudioDevice {
    ...
    func stopRendering() -> Bool {
        ...
        guard let playoutVoiceUnit else { return true}
    ...
    func stopCapture() -> Bool {
        ...
        recording = false
        guard (recordingVoiceUnit != nil) else { return true}
